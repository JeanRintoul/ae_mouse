...
# carrier             = 1e6
# 
dfx 	            = 1020 # This means we should get one dfx cycle in the pulse. 
...
'pressure_burst_length':0.1,  # in seconds(maxes out at 50% duty cycle). pressure burst length is calculated as: prf_counter/gen_pressure_sample_frequency
'current_amplitude': 3,       # its actually a voltage .. Volts. 
...
'save_folder_path':'D:\\ae_mouse\\e121_stimulation',
