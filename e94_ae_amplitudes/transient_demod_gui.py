...
# led_frequency           = 3.5 # in Hz. 

start_files             = 25  #  pressure connected. 14hz
end_files               = 30  #  pressure connected. 14hz

# start_files             = 18  #  pressure connected. 14hz
# end_files               = 24  #  pressure connected. 14hz

# start_files             = 42  #  no pressure connected. 14 hz
# end_files               = 72  #  no pressure connected. 14hz
#  
gain = 100
