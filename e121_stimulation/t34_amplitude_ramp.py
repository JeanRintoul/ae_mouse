...
for i in range(len(frequencies)):
    ...
    m_means.append(mean_m_lfp_heights)
    p_means.append(mean_p_lfp_heights)    
    m_stds.append(std_m_lfp_heights)
    p_stds.append(std_p_lfp_heights)

print ('m_means: ',m_means)
print ('m_means: ',p_means)
...
plt.plot(frequencies,m_means,'k')
plt.plot(frequencies,p_means,'b')
plt.plot(frequencies,m_means,'.k')
plt.plot(frequencies,p_means,'.b')
plt.fill_between(frequencies, m_means-m_stds, m_means+m_stds,alpha=0.2,color='grey')
plt.fill_between(frequencies, p_means-p_stds, p_means+p_stds,alpha=0.2,color='b')
ax.set_xlim([0,5050])
ax.set_xlim([0,40])
ax.set_ylim([0,np.max(m_means)+10])
...
plt.tight_layout()
plt.savefig('df_ramp.png', bbox_inches='tight')
plt.show()


fig = plt.figure(figsize=(5,5))
ax  = fig.add_subplot(111)
plt.plot(frequencies,m_means/p_means,'k')
# plt.plot(frequencies,p_means,'b')
# plt.plot(frequencies,m_means,'.k')
# plt.plot(frequencies,p_means,'.b')
# plt.fill_between(frequencies, m_means-m_stds, m_means+m_stds,alpha=0.2,color='grey')
...
ax.spines['top'].set_visible(False)
plt.tight_layout()
plt.savefig('df_ratio_ramp.png', bbox_inches='tight')
plt.show()
