...
frequency_of_interest   = 4
carrier_frequency 		= 672800
...
ax.set_title('Artefact Test @ carrier '+str(carrier_frequency)+'kHz')
plt.legend(tc,loc='upper left',frameon=False)
# ax.set_ylim([0,350])
ax.set_xlim([carrier_frequency-200,carrier_frequency+200])
plt.xticks([carrier_frequency-200,carrier_frequency,carrier_frequency+200])
ax.set_ylabel('Volts ($\mu$V)')
ax.set_xlabel('Frequency(Hz)')
# Save the figure and show
plt.tight_layout()
