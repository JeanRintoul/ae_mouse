...
frequency_of_interest   = 5
carrier_frequency = 500000
# this data is somewhat filtered. 
filename          	= 'acoustic_connection_summary_data_e96t2.npz'
nfilename          	= 'no_acoustic_connection_summary_data_e96t2.npz'
...
# ax.set_ylim([0,350])
ax.set_xlim([carrier_frequency -15*frequency_of_interest,carrier_frequency +15*frequency_of_interest])
ax.set_ylabel('Volts ($\mu$V)')
