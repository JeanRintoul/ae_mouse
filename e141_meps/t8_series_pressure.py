...
saveprefix  = './/images//'
# 
savepath             = 'D:\\ae_mouse\\e141_meps\\t8_ketamine\\pressure_ramp_vs_aeatdf1\\'
# 
outpath              = 'D:\\ae_mouse\\e141_meps\\'
# 
outname = 'aemeps_ketaminet8'
# 
# 
...
for i in range(len(pressures)):
    for j in range(n_repeats):
        ...
        filename    = savepath + 'p'+str(pressure) + '_g200.npy'
...
np.savez(outfile,frequencies = frequencies[0:final_idx],flist=flist,ps=ps,dcs=dcs,amps=amps)
