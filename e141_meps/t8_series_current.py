...
saveprefix  = './/images//'
# 
savepath             = 'D:\\ae_mouse\\e141_meps\\t8_ketamine\\voltage_ramp_vs_aeatdf1\\'
# 
outpath              = 'D:\\ae_mouse\\e141_meps\\'
# 
outname = 'aemeps_ketaminet8_current'
# 
# 
voltages = [4,5,6,7,8,9,10,11,12]
...
for i in range(len(voltages)):
    for j in range(n_repeats):
        ...
        filename    = savepath + 'v'+str(volts) + '_p0.2_g200.npy'
