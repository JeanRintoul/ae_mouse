...
v_filename    = savepath + 'tv_v0.12_g500_stream.npy'  # duration 6
# 
duration        = 6
# 
frequency       = 1
...
sos_emg_band    = iirfilter(17, [20,400], rs=60, btype='bandpass',
                       analog=False, ftype='cheby2', fs=Fs,
                       output='sos')
...
fig = plt.figure(figsize=(4,2))
ax = fig.add_subplot(111)
plt.plot(t,100*ae_emg_signal,'r')
