...
saveprefix  = './/images//'
# 
savepath             = 'D:\\ae_mouse\\e145_meps\\t1_phantom\\ae_frequency_ramp_noF21\\'
# 
outpath              = 'D:\\ae_mouse\\e145_meps\\t1_phantom\\'
# 
outname = 'aemeps_frequency_ramp'
# 
# 
freqs           = [0.5,1.0,2.0,4.0,8.0,20.0,40.0]
n_repeats       = 4
m_channel       = 0 
gain            = 500 
duration        = 6 
...
for i in range(len(freqs)):
    for j in range(n_repeats):
        ...
        frequency = freqs[i]
        repeat    = j+1
        print ('frequency/rep:',frequency,repeat-1)
        # Load the file.  
