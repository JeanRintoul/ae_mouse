...
saveprefix  = './/images//'
# 
savepath             = 'D:\\ae_mouse\\e145_meps\\t1_phantom\\pressure_ramp_dfx4hz_noF21_vout4\\'
savepath             = 'D:\\ae_mouse\\e145_meps\\t1_phantom\\pressure_ramp_dfx4hz_noF21_vout4\\'


# 
outpath              = 'D:\\ae_mouse\\e145_meps\\images\\'
# 
outname = 'aemeps_pressure_ramp'
# 
# 

pressures        = [0.05,0.1,0.15,0.2,0.25,0.3,0.35,0.4]
n_repeats       = 4
m_channel       = 0 
gain            = 500 
duration        = 6 
...
for i in range(len(pressures)):
    for j in range(n_repeats):
        ...
        repeat    = j+1
        print ('pressure/rep:',pressure,repeat)
        # Load the file.  
        #filename    = savepath + str(frequency) + 'hz\\' + 't' + str(repeat) + '_stream.npy'
        
        #filename    = savepath + 't'+str(frequency) + 'hz_rep'+str(repeat-1)+'_stream.npy'
        filename    = savepath + 't'+str(pressure) + 'v_pout_rep'+str(repeat-1)+'_stream.npy'
        ...
        df_idx      = find_nearest(frequencies,4)
        ...
        #         
        # amp_array.append([amplitude,repeat,pressure])
        # dcs_array.append([pressure,dc,repeat])
...
np.savez(outfile,frequencies = frequencies[0:final_idx],flist=flist,fs=fs,dcs=dcs,amps=amps,amp_array=amp_array,dcs_array=dcs_array)
