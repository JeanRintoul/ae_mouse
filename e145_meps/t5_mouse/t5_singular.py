...
saveprefix  = './/images//'
# 
savepath             = 'D:\\ae_mouse\\e145_meps\\t5_mouse\\'
# 
outpath              = savepath
# 
outname = 'intermodulation_distortion_voltage'
# 
...
frequency = 0.5 
filename = savepath + 'tp_p_0.2_F21_rep1_stream.npy' 
# filename = savepath + 'tp_p_0.2_noF21_rep1_stream.npy' 
filename = savepath + 'tp_p_0.24_F21_rep2_stream.npy' 
filename = savepath + '1Hz_intermodulation_distortion_from_voltage.npy' 
