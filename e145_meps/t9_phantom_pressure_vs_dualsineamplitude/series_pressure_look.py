...
# 
outpath              = 'D:\\ae_mouse\\e145_meps\\t9_phantom_pressure_vs_dualsineamplitude\\'
# 
outname = 'pressure_ramp_vs_df'
# 
# 
...
for i in range(len(pressures)):
    for j in range(n_repeats):
        ...
        # Load the file.  
        filename    = savepath + '\\p'+str(pressure)+'\\'+ 't'+ str(repeat)+'_stream.npy'
        # print ('file',filename)        
