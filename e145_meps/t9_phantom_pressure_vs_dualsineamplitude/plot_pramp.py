...
savepath           = 'D:\\ae_mouse\\e145_meps\\t9_phantom_pressure_vs_dualsineamplitude\\'

# 
# 
filename          = 'pressure_ramp_vs_df'
# 
# 
print ('filename: ', filename)
data                 = np.load(savepath+filename+'.npz', mmap_mode='r')
fs                   = data['fs']
amp                  = data['amps']
dcs                  = data['dcs']
flist                = data['flist']
...
# amp_m          = np.array(data['amp_array'])
# dcs_m          = np.array(data['dcs_array'])

# print ('fs',amp_m.shape, dcs_m.shape)
# 
# 
...
# print (amp_means,dc_means)
# print (amp)


# print ('idxs',idx)
# mean_amps = np.mean(amp,axis=1)
# print ('mean amps: ', mean_amps)
x = fs*10 
y = amp
...
plt.plot(fs*10,amp,'.')
plt.plot(np.array(freqs)*10,amp_means,'--k')
...
plt.tight_layout()
plot_filename = savepath+'_'+filename+'.png'
plt.savefig(plot_filename)
plt.show()

fig = plt.figure(figsize=(4,4))
ax  = fig.add_subplot(111)
plt.plot(fs*10,dcs,'yo')
plt.plot(np.array(freqs)*10,dc_means,'--k')
...
plt.tight_layout()
plot_filename = savepath+'_'+filename+'dcs.png'
plt.savefig(plot_filename)
plt.show()
