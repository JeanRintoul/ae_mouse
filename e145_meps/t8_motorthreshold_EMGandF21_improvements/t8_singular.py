...
saveprefix  = './/images//'
# 
savepath             = 'D:\\ae_mouse\\e145_meps\\t8_motorthreshold_EMGandF21_improvements\\'
# 
outpath              = savepath
# 
...
outname = 'noF21_rep2'
frequency = 0.5 
filename = savepath + 'tp_p_0.35_F21_rep2_stream.npy' 
filename = savepath + 'tp_p_0.35_noF21_rep2_stream.npy' 
# filename = savepath + 'tp_p_0.35_noF21_rep1_stream.npy' 
# filename = savepath + 'tp_p_0.42_F21_rep1_stream.npy' 
# filename = savepath + 'tp_p_0.39_F21_rep3_stream.npy' 
# filename = savepath + 'tp_p_0.3_noF21_rep3_stream.npy' 
...
nomains_signal    = sosfiltfilt(sos_mains_band, fsignal)
