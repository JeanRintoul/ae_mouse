...
savepath       = 'D:\\ae_mouse\\e114_mineral_oil\\t1\\'
savepath       = 'D:\\ae_mouse\\e114_mineral_oil\\t2\\'
# savepath       = 'D:\\ae_mouse\\e113_meps\\t2\\'
...
# plt.plot(frequencies,fft_vdata,'k')
plt.plot(frequencies,fft_vdata,'k')
# plt.plot(frequencies,fft_data,'k')
# ax.set_xlim([0,110])
ax.set_xlim([499750,500200])
# ax.set_xlim([490000,510000])
plt.yticks(fontsize=16)
plt.xticks(fontsize=16)
ax.spines['right'].set_visible(False)
ax.spines['top'].set_visible(False)
plt.tight_layout()
plot_filename = 'fft_vdata.png'
