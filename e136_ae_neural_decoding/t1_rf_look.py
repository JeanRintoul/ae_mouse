...
# 
# 
savepath       = 'D:\\ae_mouse\\e136_ae_neural_decoding\\t1-mouse-noVEP\\aeVEP_2Hz\\'
...
print ('shape',a,b)
gain        = 1000 
fsignal    = 10*data[channel_of_interest]
t           = np.linspace(0, duration, N, endpoint=False)

band_filter = iirfilter(17, [carrier-100,carrier+100], rs=60, btype='bandpass',
                       analog=False, ftype='cheby2', fs=Fs,
                       output='sos')
fsignal                       = sosfiltfilt(band_filter, fsignal)
