...
#
saveprefix      = './/images//' 
savepath       = 'D:\\ae_mouse\\e136_ae_neural_decoding\\t5-mouse\\'
filename = 'e136_ae_neural_decodinge136_tphantom.npz'
...
# 
# Fs is at 20kHz. 
frequencies_of_interest = [12] 
lowcut                  = 0.5
# lowcut = 4 
# bandwidth_of_interest   = 30 
bandwidth_of_interest   = 33
# 
...
sos_df = iirfilter(17, [7,bandwidth_of_interest], rs=60, btype='bandpass',
                       analog=False, ftype='cheby2', fs=Fs,
                       output='sos')
#
start_pause         = 3.5
...
plt.plot(tt,average_corrd[start_index:end_index]/np.max(average_corrd[start_index:end_index]),color='purple')
