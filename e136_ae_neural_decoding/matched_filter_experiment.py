...
saveprefix      = './/images//'
# 2Hz files. 
savepath        = 'D:\\ae_mouse\\e136_ae_neural_decoding\\t3-mouse\\aeVEP_4Hz\\'
...
for n in range(len(file_list)):
    ...
    template2    = lfp_data[int(4*Fs):int(5*Fs) ]
    ...
    mark_bit         = marker[start_index:end_index]
