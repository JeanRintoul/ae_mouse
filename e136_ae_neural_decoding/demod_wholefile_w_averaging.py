...
# 
t_series        = 't2'
outfile         = t_series + '-phantom_8Hz_100microv_data.npz'
Fs              = 5e6
new_Fs          = 1e4
...
# 
# path to files. 
savepath       = 'D:\\ae_mouse\\e136_ae_neural_decoding\\t3-mouse-goodone\\aeVEP_4Hz\\'
...
np.savez(outfile,giant_data_array=giant_data_array ,averaged_marker=averaged_marker,averaged_raw_data=averaged_raw_data,n=len(file_list) )
