...
#  
# I cannot see the railing in the averaged data? 
# Maybe, not all of it was railing? 
# I have some TERRIBLE filter artefacts. 
# 
fig = plt.figure(figsize=(8,3))
ax = fig.add_subplot(211)
