...
'duration': 4.0, 
'position': test_no,
'pressure_amplitude': 1,  # how much is lost through skull??? 400kPa, 0.08 is about 200kPz. 0.15 is about 400kPa. 
...
fft_p = fft(data[0][start_pause:end_pause])
