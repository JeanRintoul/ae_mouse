...
# downsampling_filter_lowcut = 1000 # snr demod = 24.67
# downsampling_filter_lowcut = 2000 # snr demod =  24.79
# downsampling_filter_lowcut = 5000 # snr demod = 24.96
...
for n in range(len(file_list)):
    ...
    # 
    # 
    # f_band_test =  [34., 27., 33., 35., 31., 32., 30., 26., 29.]

    # f_band_test =  [34,33]   
    # this maintains no overlap with the low frequency signal and is the real test.     
    # f_band_test = np.linspace(0,1000,21)

    # f_band_test = np.linspace(0,1000,101)
    # f_band_test = np.linspace(0,4000,41)
    # f_band_test = [18]  
    component_list = [] 
    biggest  = [0]*t
    prev_snr = 0
