...
savepath       = './/processed//'
# 
# data            = np.load(savepath + 't2-vep_different_mouse.npz')
data            = np.load(savepath + 't2-vep_different_mouse_1.npz')
veps            = -data['nfiltered_segmented_array']
# demod_veps      = data['ndemod_segmented_array']
# 
# data            = np.load(savepath + 't2-vepshielded_data_7bunch.npz')
