...
plt.suptitle('DC offset comparison')
plot_filename = 'Continuous_wave_DC_offset.png'
...
plot_filename = 'Continuous_wave_DC_RFsanitycheck.png'
plt.savefig(plot_filename)
plt.show()
...
plot_filename = 'Continuous_wave_sum_fft.png'
plt.savefig(plot_filename)
plt.show()
