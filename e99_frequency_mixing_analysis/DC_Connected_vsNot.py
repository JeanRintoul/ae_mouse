...
# SALINE
ac_file_number     = 18  # Connected 18-21
nac_file_number     = 37  # Not Connected 37-40
savepath        = 'D:\\mouse_aeti\\e99_frequency_mixing_analysis\\t3_saline\\'
...
# 
ac_fsignal   = 1e6*ac_data[v_channel]
ac_rfsignal  = 10*ac_data[rf_channel]
nac_fsignal  = 1e6*nac_data[v_channel]
