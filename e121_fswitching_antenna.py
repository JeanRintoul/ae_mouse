...
'jitter_range':0.5,             # add jitter around the prf. the time length is specificed in seconds, from which to generate a random number. 
...
'save_folder_path':'D:\\ae_mouse\\e124_pulseswitch_stimulation',
