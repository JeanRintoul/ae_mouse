...
file_list = [1,2,3,4,5]
# bad files 35. 33,38 is not so great? I need some way of selecting segments. 38
# 34 may be bad. 
# file_list = [31,32,34,36,37,39,40]
# # good file 31,32,36,   
savepath    = 'D:\\ae_mouse\\e123_phantom_GND_plane_testing\\t1\\'
gain        = 500
m_channel   = 0 
rf_channel  = 2
...
plot_filename = 't6_pulse_prf_'+str(prf)+'events_'+str(n_events)+'.png'
