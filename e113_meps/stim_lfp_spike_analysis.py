...
df_l = 5 
df_h = 15
df_band = iirfilter(17, [df_l, df_h], rs=60, btype='bandpass',
                       analog=False, ftype='cheby2', fs=Fs,
                       output='sos')
df_data        = sosfiltfilt(df_band, fsignal)
...
plt.legend(['raw','lfp'],loc='upper right')
ax2 = fig.add_subplot(312)
plt.plot(t,vsignal,'k')
plt.plot(t,lfp_v_data,'m')
plt.legend(['v data','lfp filt v data'],loc='upper right')
