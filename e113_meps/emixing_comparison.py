...
joint_applied = rfsignal/np.max(rfsignal) + vsignal/np.max(vsignal)
...
plot_filename = 'acoustoelectric_debugging.png'
plt.savefig(plot_filename, bbox_inches="tight")
plt.show()
