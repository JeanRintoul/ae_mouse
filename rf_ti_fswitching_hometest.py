...
# 
# the problem is there is so much spectral spreading, 
...
'save_folder_path':'D:\\ae_mouse\\e119_frequency_switching_prooftest',
...
# plot_filename = savepath + '\\t'+str(test_no)+'_vi_wave.png'
# plt.show()
# 
# 
# fig = plt.figure(figsize=(10,6))
