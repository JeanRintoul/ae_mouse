...
# 
savepath    = 'D:\\ae_mouse\\e131_postDAQdisaster\\t2_mouse\\epulse_100kHz\\'
gain        = 100
m_channel   = 0 
rf_channel  = 4
marker_channel = 7 
...
plot_filename = t_series+'_100kHzpulse_'+str(prf)+'events_'+str(n_events)+'.png'
