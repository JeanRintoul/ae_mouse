...
savepath    = 'D:\\ae_mouse\\e131_postDAQdisaster\\t2_mouse\\VEP_mix_500Hz_4HzLED\\'
...
for n in range(len(file_list)):
    ...
    # modulated_signal    = sosfiltfilt(modulation_filter, modulated_signal)
    # 
    ...
    alignment_indices = alignment_indices[4:27]
