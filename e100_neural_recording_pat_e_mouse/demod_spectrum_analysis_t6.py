...
# 
start_pause     = int(2.7*Fs) # int(0.2 * N+1)
end_pause       = int(3.3*Fs) # int(0.8 * N-1)
# 
...
plt.legend(['unfiltered raw measurement data'],loc='upper right')
ax.spines['right'].set_visible(False)
ax.spines['top'].set_visible(False)
plot_filename = 'raw_data_big_DC_offset.png'
