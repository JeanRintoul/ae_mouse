...
fonts                          = 16
# 
savepath             = 'D:\\ae_mouse\\e147_meps\\t6_mouse_good\\aedc4\\'
outpath              = savepath 
# 
ae_filename   = savepath + 'tae_g500_stream.npy'        # duration 6
p_filename    = savepath + 'tp_p0.2_g500_stream.npy'   # duration 6 
v_filename    = savepath + 'tv_v6_g500_stream.npy'      # duration 6
# 
duration        = 6
# 
frequency       = 1.0
