...
print ('size of signal at PRF:(microvolts)',1e6*2*fft_nopreamp[prf_idx])
# 
carrier_idx = m.find_nearest(frequencies,acoustic_frequency)
print ('size of signal at carrier:(volts)',2*fft_nopreamp[carrier_idx])
# 
prf_sum_idx = m.find_nearest(frequencies,prf+acoustic_frequency*2)
print ('size of signal at sum PRF:(microvolts)',1e6*2*fft_nopreamp[prf_sum_idx])
# 
# 
