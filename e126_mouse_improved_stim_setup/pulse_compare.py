...
# 
plt.legend(['ERP iso=0.75,n='+str(erp_events),'Anesthesia iso=1.5,n='+str(a_events),'Phantom,n='+str(p_events)],loc='upper right',framealpha=0.0,fontsize=16)
# 
plt.title('Pulse Neural Response',fontsize=16)
plot_filename = 'pulse_comparison_tight_filter.png'
