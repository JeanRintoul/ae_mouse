...
factor         = 1
savepath       = 'D:\\mouse_aeti\\e97_MEPS\\t20_mep_mouse_w2xtx\\'
Fs              = 5e6
duration        = 8.0
timestep        = 1.0/Fs
N               = int(Fs*duration)
...
#                        analog=False, ftype='cheby2', fs=Fs,
#                        output='sos')
# fsignal  = sosfiltfilt(sos_low, mdata)
...
low  = 0.0001
high = 1000
sos_2 = iirfilter(17, [high], rs=60, btype='lowpass',
                       analog=False, ftype='cheby2', fs=Fs,
                       output='sos')
fsignal2  = sosfiltfilt(sos_2, mdata)


low  = 499000
high = 501000
sos_3 = iirfilter(17, [low,high], rs=60, btype='bandpass',
                       analog=False, ftype='cheby2', fs=Fs,
                       output='sos')
fsignal3  = sosfiltfilt(sos_3, mdata)
...
start_pause     = int(3.5/8 * N+1)
end_pause       = int(6/8 * N-1)
...
plt.plot(t,1e6*data[m_channel]/gain,'green')
plt.plot(t,fsignal2,'k')
plt.plot(t,fsignal3,'c')
ax.set_xlim([0,8])
