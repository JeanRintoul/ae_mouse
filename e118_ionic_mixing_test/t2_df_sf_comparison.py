...
savepath       = 'D:\\ae_mouse\\e118_ionic_mixing_test\\t2\\'
dfx            = 10
file_number    = 5 # v out = 0.15 2Mhz carrier. vout = 0.25
file_number    = 14 # v out = 0.15 500khz carrier. vout = 0.25
...
sf_idx      = find_nearest(frequencies,2*500000+dfx)
print ('file number',str(file_number))
print('df amplitude(microvolts)',2*fft_data[df_idx]) 
print('sf amplitude(microvolts)',2*fft_data[sf_idx]) 
...
sos_sf_band = iirfilter(17, [1e6+5, 1e6+15], rs=60, btype='bandpass',
                       analog=False, ftype='cheby2', fs=Fs,
                       output='sos')
sum_data        = sosfiltfilt(sos_sf_band, fsignal)
sum_v_data      = sosfiltfilt(sos_sf_band, 1e6*vsignal)
# 
df_l = 300
df_h = 1500
...
ax.spines['right'].set_visible(False)
ax.spines['top'].set_visible(False)
plot_filename = freq+'_rfti_dffft.png'
...
ax  = fig.add_subplot(111)
plt.plot(frequencies,fft_data,'k')
ax.set_xlim([1,(1e6+40)])
ax.set_ylim([0,0.2])
ax.spines['right'].set_visible(False)
ax.spines['top'].set_visible(False)
plot_filename = freq+'_rfti_sffft.png'
plt.yticks(fontsize=16)
plt.xticks(fontsize=16)
plt.tight_layout()
plt.savefig(plot_filename, bbox_inches="tight")
...
# ax.set_xlim([0,110])
# ax.set_xlim([0,110])
# plt.plot(t,-100+vsignal,'r')
plt.yticks(fontsize=16)
plt.xticks(fontsize=16)
ax.spines['right'].set_visible(False)
ax.spines['top'].set_visible(False)
plt.tight_layout()
plot_filename = freq+'_rfti_lfp.png'
plt.savefig(plot_filename, bbox_inches="tight")
plt.show()
...
ax.spines['top'].set_visible(False)
plt.tight_layout()
plot_filename = freq+'_rfti_sum.png'
plt.savefig(plot_filename, bbox_inches="tight")
plt.show()
...
# plt.yticks(fontsize=16)
# plt.xticks(fontsize=16)
# plot_filename = 'df_modulated10.png'
# plt.savefig(plot_filename, bbox_inches="tight")
# plt.show()
...
# plot_filename = '10Hz_comparison.png'
# plt.savefig(plot_filename, bbox_inches="tight")
# plt.show()
# 
# 
