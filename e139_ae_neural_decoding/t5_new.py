...
# periods_of_interest         = 112
# periods_of_interest         = 4*27 # whole file. 
periods_of_interest           = 283 # whole file. 
# periods_of_interest           = 113 # whole file. 
# periods_of_interest           = 200 # whole file. 
