...
savepath    = 'D:\\ae_mouse\\e137_ae_neural_decoding\\t2_mouse\\4Hz_VEP\\'
savepath    = 'D:\\ae_mouse\\e137_ae_neural_decoding\\t2_mouse\\4Hz_VEP2\\'
# savepath    = 'D:\\ae_mouse\\e137_ae_neural_decoding\\t3_mouse\\4Hz_VEP\\'

# savepath    = 'D:\\ae_mouse\\e138_ae_neural_decoding\\t6_mouse_position_calibration\\3Hz_VEP\\'
start       = 1
stop        = 11
step        = 1 
file_list   = range(start,stop,step)
print ('file list',file_list)
outfile  = 'vep_template_t6.npz'
# Fs = 5e6
# Fs = 2e6
Fs              = 1e5
new_Fs          = 1e4
...
for n in range(len(file_list)):
    ...
    alignment_indices = alignment_indices[0:len(alignment_indices)]
...
# Compute the FFT of this
newN = len(average_lfp)
xf = np.fft.fftfreq( (newN), d=1/new_Fs)[:(newN)//2]
raw_frequencies = xf[1:(newN)//2]
fft_raw  = fft(average_lfp)
