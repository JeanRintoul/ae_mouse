...
# savepath        = 'D:\\ae_mouse\\e142_ae_neural_decoding\\t1\\10hz_aeisolation_test\\'
savepath        = 'D:\\ae_mouse\\e139_ae_neural_decoding\\t5_mouse\\ae_10Hz_g2000\\'
...
outpath         = 'D:\\ae_mouse\\e139_ae_neural_decoding\\t5_mouse\\'
# 
outfile         = 'e139t5_10Hz_g2000'
...
# np.savez(outfile+'.npz',t = t,marker_summation=marker_summation,rawdata_summation=rawdata_summation,lfp_summation=lfp_summation,carrier_band_summation=carrier_band_summation)
...
plt.xticks([carrier-10,carrier+10,carrier-20,carrier-40,carrier,carrier+20,carrier+40])
# ax.set_ylim([0,20])
ax.set_ylim([0,0.1])
