...
'current_amplitude': 1,   #  its actually a voltage .. Volts. 0.0002
...
'save_folder_path':'D:\\mouse_aeti\\e87_filter_transfer_fcns',
...
# frequencies2 = list(np.linspace(500,500000,num=15))
# frequencies3 = list(np.linspace(13000,600000,num=11))
# 
frequencies = [3,5,10,20]
frequencies2 = list(np.linspace(30,20000,num=11))
frequencies = frequencies+frequencies2
# 
# frequencies = frequencies+frequencies2+frequencies3
# frequencies2 = list(np.linspace(30,3000,num=20))
# frequencies = frequencies2
# 
# frequencies = list(np.linspace(1,5000,num=20))
