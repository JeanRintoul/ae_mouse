...
band_limit = 1
c_band = iirfilter(17, [carrier_f-band_limit,carrier_f+band_limit], rs=60, btype='bandpass',
...
lp_filter               = iirfilter(17, [high], rs=60, btype='lowpass',
                            ...
                            output='sos')
# # 
lfp_signal             = sosfiltfilt(lp_filter, fsignal) 
# # 

# # do the demodulation
fraw            = sosfiltfilt(sos_carrier_band, fsignal) 
craw            = sosfiltfilt(c_band, fsignal) 
demod_data      = demodulate2(fraw,craw)
...
plt.plot(t,demod_data,'r')
# plt.legend(['lfp','direct multiplication demod'],loc='upper right')
plt.show()
