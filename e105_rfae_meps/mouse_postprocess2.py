...
filename      = 'mouse_demodulation.npz'
...
low  = prf -(signal_of_interest +2)
high = prf +(signal_of_interest +2)
...
plt.plot(frequencies,fft_hdata,'r')
plt.plot(frequencies,fft_d2data,'m')
plt.show()
