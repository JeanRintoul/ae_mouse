...
#
outfile = 'fswitch_phantom_data.npz'
# outfile = 'fswitch_data.npz'
# 
t_series = 't4'
savepath    = 'D:\\ae_mouse\\e124_pulseswitch_stimulation\\t4_phantom\\'
gain        = 500
m_channel   = 0 
rf_channel  = 2
...
plot_filename = t_series+'_fswitch_prf_'+str(prf)+'events_'+str(n_events)+'.png'
