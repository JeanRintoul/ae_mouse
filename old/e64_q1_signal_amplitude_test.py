...
'current_amplitude': 0.000002,   #  its actually a voltage .. Volts. 0.0002
'current_frequency': 7000,
'ti_frequency': 0,          # if this is included or  > 0 it means we are adding two sine waves together. i.e. TI. 
'ae_channel': 5,            # the channel of the measurement probe. 
...
'gain':1,
'marker_channel':0,
'command_c':'signal_test_stream',
'save_folder_path':'D:\mouse_aeti\e64_signal_testing',
}
#  
...
low_cut  = 6000  # where do papers normally put this cut-off? 
high_cut = 10000
