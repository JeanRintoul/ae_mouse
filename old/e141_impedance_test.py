...
# 
print ('here ...')
current_signal_frequency = 500000.0
...
'save_folder_path':'D:\\ae_mouse\\e141_meps',
...
print ('impedance = v/i : ', 2*fft_v[current_idx],2*fft_i[current_idx])
print ('impedance = ', fft_v[current_idx]/fft_i[current_idx])
