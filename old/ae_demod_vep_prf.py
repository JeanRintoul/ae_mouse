...
'pressure_prf':1000,        # pulse repetition frequency for the sine wave. Hz.
'pressure_ISI':6.0,         # inter trial interval in seconds. 
'pressure_burst_length':6.0,  # burst length in seconds. 
