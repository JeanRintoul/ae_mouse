#!/usr/bin/python
'''
 Author: Jean Rintoul Date: 07/10/2022

 Record a signal, and report some signal to noise metric? 
...
'current_amplitude': 0.001,   #  its actually a voltage .. Volts. 0.0002
'current_frequency': 10,
# 'ti_frequency': 2010,       # if this is included or  > 0 it means we are adding two sine waves together. i.e. TI. 
# 'ti_frequency': 2900,       # if this is included or  > 0 it means we are adding two sine waves together. i.e. TI. 
'ae_channel': 6,            # the channel of the measurement probe. 
...
'save_folder_path':'D:\mouse_aeti\e67_improved_noise_ECoG',
...
#  
# this is the preamp gain. If not using a preamp, set it to 1.
...
snr = 20*np.log(fft_pp/fft_baseline)
print ('snr: ',snr)
...
low_cut  = 1.0  # where do papers normally put this cut-off? 
high_cut = 45
...
# print ('filtered data snr: ',filt_pp/fft_filt_baseline  )

print ('filtered data pp amplitude', filt_pp)

print('I-V TOTAL PHASE OFFSET: ',data_out[0][5]-90)
...
plot_filename = savepath + '\\t'+str(test_no)+'_raw_measured_data.png'
plt.savefig(plot_filename,bbox_inches='tight')
plt.show()

fig = plt.figure(figsize=(10,6))
ax = fig.add_subplot(121)
plt.plot(t, 1e6*data[m_channel]/gain, color = 'red')
plt.plot(t, 1e6*filtered_data/gain, color = 'purple')
ax2 = fig.add_subplot(122)
plt.plot(frequencies, 1e6*fft_filt/gain, color = 'purple')
ax2.set_xlim([0,50])
plot_filename = savepath + '\\t'+str(test_no)+'_measured_signaltest.png'
plt.savefig(plot_filename,bbox_inches='tight')
plt.show()
...
# plt.plot(t, data[v_channel], color = 'purple')
# plt.plot(t, data[m_channel], color = 'green')
# plt.plot(t, data[i_channel], color = 'red')
# # plt.plot(frequencies, fft_m, color = 'purple')
# # ax.set_xlim([0,50])
# # ax.set_xlabel('Frequency(Hz)')
# ax.set_ylabel('Volts(V)')
# plt.legend(['v chan','measured data','i chan'],loc='upper right', fontsize = 8)
# ax.spines['right'].set_visible(False)
# ax.spines['top'].set_visible(False)
# plot_filename = savepath + '\\t'+str(test_no)+'_applied_signals.png'
# plt.savefig(plot_filename,bbox_inches='tight')
# plt.show()
...
# ax.spines['right'].set_visible(False)
# ax.spines['top'].set_visible(False)
# plot_filename = savepath + '\\t'+str(test_no)+'_fftnoise.png'
# plt.savefig(plot_filename,bbox_inches='tight')
# plt.show()
...
# fig = plt.figure(figsize=(10,6))
# ax = fig.add_subplot(111)
# plt.plot(t,v_data/np.max(v_data),color='r')
# plt.plot(t, i_data/np.max(i_data), color = 'g')
# ax.set_xlabel('Time(s)')
# ax.set_ylabel('Volts(V)')
# plt.legend(['norm v','norm i'],loc='upper right', fontsize = 8)
# ax.spines['right'].set_visible(False)
# ax.spines['top'].set_visible(False)
# plot_filename = savepath + '\\t'+str(test_no)+'_phase_comparison.png'
# plt.savefig(plot_filename,bbox_inches='tight')
# plt.show()