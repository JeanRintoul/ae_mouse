...
'duration': duration, 
'position': test_no,
'pressure_amplitude': 0.02,      	# how much is lost through skull??? 400kPa, 0.08 is about 200kPz. 0.15 is about 400kPa. 
...
'save_folder_path':'D:\\ae_mouse\\e143_twotonepreamp_test',
...
for i in x:
	...
	# plt.legend(['fft m'],loc='upper right')
	# plt.show()	
	...
	if (iteration_number%calculate_nth == 0 or i == (multifile_end-1) ):
		...
		plt.plot(frequencies,fft_m,'k')
		plt.plot(frequencies,fft_mk,'r')
		ax.set_xlim([carrier-bandwidth_of_interest,carrier+bandwidth_of_interest])
		plt.legend(['fft around carrier signal (REC)','Kaiser'],loc='upper right')
		ax2 = fig.add_subplot(412)
		plt.plot(frequencies,fft_m,'k')
		plt.plot(frequencies,fft_mk,'r')
		ax2.set_ylim([0,0.1])
		ax2.set_xlim([carrier-bandwidth_of_interest,carrier+bandwidth_of_interest])
...
# 
# 
outfile = savepath + 'e136_tphantom.npz'
