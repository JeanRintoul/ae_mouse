...
current_amplitude  = 0.04
pressure_amplitude = 0.05
# 
# 
aeti_variables = {
...
aeti_variables['fileprefix'] = 'ae_g'+str(brain_gain)
...
aeti_variables['fileprefix'] = 'p_p' +str(pressure_amplitude)+'_g'+str(brain_gain)
result, data_out            = m.aeti_recording(**aeti_variables)
data                        = m.copy_to_folder_and_return_data(**aeti_variables)
# Test 3: v only
aeti_variables['pressure_amplitude'] = 0
aeti_variables['current_amplitude'] = current_amplitude
aeti_variables['fileprefix'] = 'v_v' +str(current_amplitude)+'_g'+str(brain_gain)
result, data_out            = m.aeti_recording(**aeti_variables)
data                        = m.copy_to_folder_and_return_data(**aeti_variables)
