...
'save_folder_path':'D:\mouse_aeti\e72_system_testing',
...
# plt.plot(t, sine_wave, color = 'red')
plt.plot(t, data[marker_channel], color = 'orange')

plt.legend(['raw measured data','marker'],loc='upper right', fontsize = 8)
# ax.set_xlim([0,8])
# plt.xlim([4.00,4.01])
# plt.xlim([4.00,4.8])
