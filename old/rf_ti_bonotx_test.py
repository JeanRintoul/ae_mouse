...
# #  
v_amplitude = aeti_variables['current_amplitude']
...
# this is if I use the daq differential input. 
...
print ('vin:',v_amplitude)
print ('df p-p:',2*fft_m[df_idx])
print ('rf p-p:',2*fft_v[carrier_idx], np.max(vsignal[start_pause:end_pause]) )
# 
# 
fig = plt.figure(figsize=(10,6))
ax = fig.add_subplot(411)
plt.plot(t,vsignal,'r')
plt.legend(['v monitor signal'],loc='upper right')
ax2 = fig.add_subplot(412)
plt.plot(frequencies,fft_v,'r')
plt.legend(['v fft'],loc='upper right')
...
plot_filename = savepath + '\\t'+str(test_no)+'_rfti_bonotx1.png'
