...
'save_folder_path':'D:\mouse_aeti\e69_mouse_4',
...
'''
   Implement mains harmonic filter, until I can remove the source of it. 
...
fig = plt.figure(figsize=(10,6))
ax = fig.add_subplot(111)
plt.plot(t, data[m_channel], color = 'g')
# plt.plot(t,v_data,color='r')
plt.plot(t, fsignal, color = 'b')
ax.set_xlabel('Time(s)')
ax.set_ylabel('Volts(V)')
# plt.legend(['norm v','norm i'],loc='upper right', fontsize = 8)
ax.spines['right'].set_visible(False)
ax.spines['top'].set_visible(False)
plot_filename = savepath + '\\t'+str(test_no)+'_doesitwork.png'
plt.savefig(plot_filename,bbox_inches='tight')
plt.show()
# 
# 
