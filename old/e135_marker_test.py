...
# Now do time alignment based on when the blip occurs, and save out the file again. 
# x = data[1]
# distance_in_samples = Fs/(2*np.pi*8000)
# print ('distance in samples:',distance_in_samples)
# # Find the point at which... 
# peaks, properties = find_peaks(x, distance = distance_in_samples,width=distance_in_samples)
# x = data[1]
# peaks, properties = find_peaks(x,height = (0.02,0.09) )
# first_marker = peaks[0]
# print ('start peak is: ',first_marker )
...
# However, now I want the marker channel to start, synced with the generator start, not the daq recording start. 
# 
