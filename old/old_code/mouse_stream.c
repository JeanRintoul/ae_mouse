...
// Define the constants used. 
  ...
  // this one: 
  double dRanges[8] = {0.2,0.2,20.0,20.0,2.0,0.2,8.0,40.0}; 
  ...
  uint64_t Couplings[8] = {CK_DCV,CK_DCV,CK_DCV,CK_DCV,CK_ACV,CK_DCV,CK_DCV,CK_DCV};
  // 
  ...
  {  
    ...
    else if (i < (int)pressure_start_time && i >= (int)pressure_start_null) {  // start of ramp
