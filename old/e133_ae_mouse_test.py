...
# 'current_burst_length':1.0, #0.05,    # 50ms 
# 'current_prf':prf,
...
# 
print ('df/sf/carrier:',frequencies[df_idx],frequencies[sig_idx],frequencies[carrier_idx])
print ('df and sig:',2*fft_m[df_idx],2*fft_m[sig_idx],2*fft_m[carrier_idx])
# # 
...
ax2.set_xlim([carrier - current_signal_frequency - bandside,carrier + current_signal_frequency + bandside])
