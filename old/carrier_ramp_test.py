...
'save_folder_path':'D:\\mouse_aeti\\e74_nr_ketxyl_screw_mouse\\transfer_function\\carrier_ramp',
...
carriers = [5,10,20,40,100,130,200,400,800,1600,3200,6400,12800]
print ('carriers',carriers)

data       = []
for i in range(len(carriers)): 
  f =  round(carriers[i],2)
  aeti_variables['current_frequency'] = f
  aeti_variables['ti_frequency'] = f+1
