...
'current_amplitude': 1,       # its actually a voltage .. Volts. 1.5v was good. 
...
spike_band =  iirfilter(17, [300,1000], rs=60, btype='bandpass',
                           analog=False, ftype='cheby2', fs=Fs,
                           output='sos')
...
nopreamp_lfp_data    = sosfiltfilt(lfp_band, data[5])
# 
# fig = plt.figure(figsize=(10,6))
# ax  = fig.add_subplot(211)
# plt.plot(t,data[5],'k')
# ax2  = fig.add_subplot(212)
# plt.plot(t,nopreamp_lfp_data,'k')
# plt.show()
# 
fig = plt.figure(figsize=(10,6))
...
plt.legend(['lfps'],loc = 'upper right')
