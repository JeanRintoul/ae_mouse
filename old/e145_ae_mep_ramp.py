...
for i in range(4):
    ...
    # aeti_variables['fileprefix'] = 'ae_ae_p' +str(pressure_amplitude)+'_v'+str(current_amplitude)+'_g'+str(gain) #  +'_df' +str(dfx)+'hz'
    # if I do a frequency ramp. 
    # aeti_variables['fileprefix'] = str(dfx)+'hz_rep'+str(iteration)
    # if I do a pressure ramp.    
    aeti_variables['fileprefix'] = str(pressure_amplitude)+'v_p_rep'+str(iteration) 
...
# aeti_variables['fileprefix'] = 'p_ae_p' +str(pressure_amplitude)+'_v'+str(0.0)+'_g'+str(gain)
# result, data_out            = m.aeti_recording(**aeti_variables)
# data                        = m.copy_to_folder_and_return_data(**aeti_variables)
# # Test 3: v only
# aeti_variables['pressure_amplitude'] = 0
# aeti_variables['current_amplitude'] = current_amplitude
# aeti_variables['fileprefix'] = 'v_ae_p' +str(0.0)+'_v'+str(current_amplitude)+'_g'+str(gain)
# result, data_out            = m.aeti_recording(**aeti_variables)
# data                        = m.copy_to_folder_and_return_data(**aeti_variables)
# # 
# 
