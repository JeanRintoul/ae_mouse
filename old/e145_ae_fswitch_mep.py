...
'no_ramp':0,                  # when we have no ramp we set this to 1. i.e. an impedance spectrum test. 
...
aeti_variables['fileprefix'] = 'ae_fswitch_p_g'+str(gain)
...
aeti_variables['fileprefix'] = 'p_fswitch_p' +str(pressure_amplitude)+'_g'+str(gain)
result, data_out            = m.aeti_recording(**aeti_variables)
data                        = m.copy_to_folder_and_return_data(**aeti_variables)
# Test 3: v only
aeti_variables['pressure_amplitude'] = 0
aeti_variables['current_amplitude'] = current_amplitude
aeti_variables['fileprefix'] = 'v_fswitch_v' +str(current_amplitude)+'_g'+str(gain)
result, data_out            = m.aeti_recording(**aeti_variables)
data                        = m.copy_to_folder_and_return_data(**aeti_variables)
