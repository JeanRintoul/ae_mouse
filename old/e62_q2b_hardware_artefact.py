...
'ti_frequency': 12000,          # if this is included or  > 0 it means we are adding two sine waves together. i.e. TI. 
...
'save_folder_path':'D:\mouse_aeti\e62_mouse_1\q2\\b_hardware_artefact',
}
#  
...
ax.set_xlim([0,21000])
# plt.xlabel('time(s)')
plot_filename = savepath + '\\artefact_frequency.png'
plt.savefig(plot_filename)
plt.show()