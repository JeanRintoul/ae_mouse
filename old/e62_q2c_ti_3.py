...
'ti_frequency': 500010,     # if this is included or  > 0 it means we are adding two sine waves together. i.e. TI. 
...
'save_folder_path':'D:\mouse_aeti\e62_mouse_1\q2\\c_ti_3',
}
#  
...
# plt.xlabel('time(s)')
# plot_filename = savepath + '\\lfp.png'
...
# ax.spines['top'].set_visible(False)
# # plt.xlabel('time(s)')
# plot_filename = savepath + '\\lfp_plot.png'
# plt.savefig(plot_filename)
# plt.show()
...
ax.spines['right'].set_visible(False)
ax.spines['top'].set_visible(False)
ax.set_xlim([0,1001000])
# plt.xlabel('time(s)')
plot_filename = savepath + '\\'+str(test_no)+'ti_frequency.png'
plt.savefig(plot_filename)
plt.show()