...
# 
current_signal_frequency 	= 26 # This is set up for a 2Hz VEP. 
multifile_start 			= 1 
multifile_end   			= 2
gain                		= 500
Fs                  		= 2e6
...
'end_pause': 0,          # start of end ramp
'start_null': 0.,              # percent of file set to zero at the beginning. 
'start_pause': 0,      # percent of file in ramp mode or null at start.
...
fft_f  = fft(fsignal*window)
fft_f  = np.abs(2.0/(N) * (fft_f))[1:(N)//2]

fig 	 = plt.figure(figsize=(5,5))
ax 		 = fig.add_subplot(111)
plt.plot(frequencies,fft_f,'k')
