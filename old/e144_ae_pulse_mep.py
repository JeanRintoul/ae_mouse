...
aeti_variables['fileprefix'] = 'ae_pulse_p' +str(pressure_amplitude)+'_v'+str(current_amplitude)+'_g'+str(gain)
...
aeti_variables['fileprefix'] = 'p_pulse_p' +str(pressure_amplitude)+'_v'+str(0)+'_g'+str(gain)
result, data_out            = m.aeti_recording(**aeti_variables)
data                        = m.copy_to_folder_and_return_data(**aeti_variables)
# Test 3: v only
aeti_variables['pressure_amplitude'] = 0
aeti_variables['current_amplitude'] = current_amplitude
aeti_variables['fileprefix'] = 'v_pulse_p' +str(0)+'_v'+str(current_amplitude)+'_g'+str(gain)
result, data_out            = m.aeti_recording(**aeti_variables)
data                        = m.copy_to_folder_and_return_data(**aeti_variables)
