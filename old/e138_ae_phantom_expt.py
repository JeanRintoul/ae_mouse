...
# 
current_signal_frequency 	= 10 # This is set up for a 2Hz VEP. 
multifile_start 			= 1 
multifile_end   			= 2
gain                		= 500
# Fs                  		= 5e6 #
...
# 
# How long can I go? 8s, 12s. I cannot go above 12 seconds. 
# I think the problem, is the amount of data going into the generator...as it all needs to be stored in memory.  
# as it is an arbitrary file. 
# I don't specifically need such control here. I do not HAVE to have the start and end points. 
# This means I could, make a new piece of code that does NOT use the arbitrary function gen, 
# Or one which implements repeats?? 
# What might be easiest, is to have no on/off ramp, and do repeats? 
# 
# I can now go up to 60 seconds if I use the long recording option. 
duration 					= 30
test_no  					= 1
...
'rf_monitor_channel': 4,      # this output of the rf amplifier.         # this output of the rf amplifier.  
...
'start_null': 0.03,             # percent of file set to zero at the beginning. 
# 'start_null': 0.0,
...
'save_folder_path':'D:\\ae_mouse\\e138_ae_neural_decoding',
...
# plt.plot(t,marker,'r')
plt.plot(t,fsignal,'b')
# ax.set_xlim([5,5.001])
ax2 = fig.add_subplot(312)
plt.plot(frequencies,fft_mk)
...
# 
# Do averaging. 
# temp channel adjust for 10Mhz sampling rate. 
