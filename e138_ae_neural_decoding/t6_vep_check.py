...
t_series = 'template'
# 
savepath    = 'D:\\ae_mouse\\e138_ae_neural_decoding\\t6_mouse_position_calibration\\ae_3Hz_VEP_pvout0.12\\'
start       = 1
stop        = 6
step        = 1 
...
for n in range(len(file_list)):
    ...
    alignment_indices = alignment_indices[0:len(alignment_indices)-2]
