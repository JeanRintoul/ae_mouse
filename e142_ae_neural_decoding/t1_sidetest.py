...
saveprefix  = './/images//'
# 
savepath             = 'D:\\ae_mouse\\e140_ae_neural_decoding\\t2\\'
# filename             = 't1ae10.npz'
# filenamest           = 't1sidetest.npz'
# # 
# filename             = 't7ae10.npz'
# filenamest           = 't7sidetest.npz'
# # 
# filename             = 't2ae10.npz'
# filenamest           = 't2sidetest.npz'
# 
# filename             = 't3ae10.npz'
# filenamest           = 't3sidetest.npz'
# 
# filename             = 't6ae10.npz'
# filenamest           = 't6sidetest2.npz'
# 
# 
# filename             = 't8ae10.npz'
# filenamest           = 't8sidetest.npz'
# 
filename             = 'e140t_10Hz_g2000.npz'
filenamest           = 'e140t1_isolation_g2000.npz'
# 

filename             = 'e140t2_10Hz_g2000.npz'
filenamest           = 'e140t2_sidetest_g2000.npz'
...
ax.set_xlim([carrier-band_limit,carrier+band_limit])
ax.set_ylim([0,0.08])
plt.xticks([carrier-10,carrier-20,carrier-30,carrier+10,carrier+20,carrier+30],fontsize=f)
plt.yticks(fontsize=f)
ax.spines['right'].set_visible(False)
ax.spines['top'].set_visible(False)
ax.ticklabel_format(useOffset=False)
