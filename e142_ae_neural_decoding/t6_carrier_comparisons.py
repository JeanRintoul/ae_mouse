...
# compared to e140 t8. file 3,12,13 are good. 
# savepath = 'D:\\ae_mouse\\e140_ae_neural_decoding\\t8\\10hz_aevepg5000_good\\'
# filename = 't3_stream.npy'
# # 

outpath = 'D:\\ae_mouse\\e142_ae_neural_decoding\\t6_mouse\\'
# # F21 VEP amplitude. 
# # 
# # 
gain            = 5000
...
plt.yticks(fontsize=f)
plt.tight_layout()
plot_filename = outpath +'_carrier.png'
...
ax.spines['top'].set_visible(False)
plt.tight_layout()
plot_filename = outpath +'_vep.png'
plt.savefig(plot_filename)
plt.show()
