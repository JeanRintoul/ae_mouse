...
saveprefix  = './/images//'
# 
savepath             = 'D:\\ae_mouse\\e142_ae_neural_decoding\\'
# 
# 
filename             = 't4_10Hz.npz'
filenamest           = 't4_isolation.npz'
# 
# 
...
# plt.plot(t,rawdata_summation,'k')
# plt.show()
...
plt.plot(frequencies,fft_rawkst,'m')
