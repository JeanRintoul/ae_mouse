...
ae_filename    = 'D:\\ae_mouse\\e115_F21_hydrophone\\t5_electricfieldonly_hydrophone\\t2_stream.npy'
ae_data = np.load(ae_filename)
a,b = ae_data.shape
print ('ae shape',a,b)

h_filename    = 'D:\\ae_mouse\\e108_hydrophone_sync_revision\\prf_hydrophone_stream.npy'
...
plt.savefig("hydrophone_efield_prf.png", bbox_inches="tight") 
plt.show()
...
plt.savefig("hydrophone_pfield_prf.png", bbox_inches="tight") 
plt.show()
...
ax2.spines['right'].set_visible(False)
ax2.spines['top'].set_visible(False)
plt.savefig("hydrophone_pfield_prf_zoom.png", bbox_inches="tight") 
plt.show()
...
ax.spines['right'].set_visible(False)
ax.spines['top'].set_visible(False)
plt.savefig("hydrophone_efield_prf_hf_t5.png", bbox_inches="tight") 
plt.show()
...
# plt.legend(['hydrophone'],loc='upper right')
ax2.set_ylim([0,6])
ax2.set_xlim([1e6-20000,1e6+20000])
plt.xticks(fontsize=fz)
plt.yticks(fontsize=fz)
ax2.spines['right'].set_visible(False)
ax2.spines['top'].set_visible(False)
...
ax.spines['right'].set_visible(False)
ax.spines['top'].set_visible(False)
plt.savefig("hydrophone_efield_prf_sf_t5.png", bbox_inches="tight") 
plt.show()
# 
